...
> 2026-09-12 更新：收藏入口已限定「景點」，餐廳／住宿不顯示。收藏模式以資料夾取代縣市；兩個頁面入口已透過 CloudPlannerItemPicker 讀取雲端。以下舊版介面說明若有衝突，以 `planner-favorites-supabase-integration.md` 為準；個人頁資料夾仍待接入雲端寫入。
